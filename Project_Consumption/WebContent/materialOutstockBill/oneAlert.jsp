...
<script>
 ...
 <div class="pop_box hide">
                    ...
                    <div class="contentP">
                        ...
                        <div class="textmian">
                        	<p>审核中需要进行物料品质检测</p>
                       		<form action="outmaterialHouseMaterial" method="post">	
                       		 	  <input type="hidden" name="materialOutstockBill.billId" value="${materialOutstockBill.billId}" />			        			    				   							    
							      <input type="hidden" name="mwareHouseMaterial.material.materialId" value="${materialOutstockBill.material.materialId}" />			        
							      <input type="hidden" name="mwareHouseMaterial.mwareHouse.wareId" value="${materialOutstockBill.mwareHouse.wareId}" />							  			      							        
							      <input type="hidden" name="mwareHouseMaterial.flag" value="0"/>
							      <input type="hidden" name="mwareHouseMaterial.quantity" value="-${materialOutstockBill.quantity}"/>							      				    
