		...
		<div id="container" class="easyui-layout" style="width:1024px;height:800px;padding:1px;margin-left:auto; margin-right:auto;">
			...
			<div data-options="region:'center',title:'欢迎使用',iconCls:'icon-ok'" style="height:100%;">
				<div id="mainbody" style="height:90%">
				  <center>
				    <h1 style="color:skyblue;">修改消费记录</h1>
				    <div style="padding:3px;color:red;">
				      ${msg}
				    </div>
				    <form action="consume-update" method="post">
				      <input id="consume_id" type="hidden" name="consume_id" value="${consume.consume_id}"/>
				      ...
				      <div style="padding:3px;">
				        ...
				        <select id="type_id" class="easyui-validatebox textbox" name="type.type_id" style="width:180px;">
				          ...
				          <c:forEach items="${types}" var="type">
				            <c:choose>
				              <c:when test="${type.type_id == consume.type.type_id}">
				      ...
				      <input type="hidden" id="consumer_id" name="consumer.consumer_id" value="${consume.consumer.consumer_id}"/>
				      
				      <div style="padding:3px;">
				        <label for="consume_date">消费日期：</label>
				        <input id="consume_date" class="easyui-datebox" value="${consume.consume_date}" type="text" name="consume_date" data-options="required:true"/>
				      </div>
				      <div style="padding:3px;">
