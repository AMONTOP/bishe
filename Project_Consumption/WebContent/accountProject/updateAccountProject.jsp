  ...
  <body>
		<div id="container" class="easyui-layout" style="width:1024px;height:800px;padding:1px;margin-left:auto; margin-right:auto;">
				<div id="mainbody" style="height:90%">
				  <center>
				    <h1 style="color:skyblue;">修改财务项目报销</h1>
				    <div style="padding:3px;color:red;">
				      ${msg}
				    </div>
				    <form action="updateaccountProject" method="post">
				      <input id="clientId" type="hidden" name="accountProject.accountId" value="${accountProject.accountId}"/>
