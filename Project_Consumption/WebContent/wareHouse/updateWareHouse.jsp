				...
				<div id="mainbody" style="height:90%">
				  <center>
				    ...
				    <form action="updatewareHouse" method="post">
				      <input id="wareId" type="hidden" name="wareHouse.wareId" value="${wareHouse.wareId}"/>
				      <div style="padding:3px;">
				        <label for="wareHouse.wareNo">仓库名：</label>
				        <input id="wareHouse.wareNo" type="text" name="wareHouse.wareNo" value="${wareHouse.wareNo}" class="easyui-validatebox textbox" data-options="required:true"/>
				      </div>
				      <div style="padding:3px;height: 54px;">
				        <label for="wareHouse.wareCapacity">仓库容量：</label>
				        <input class="easyui-slider" style="width:300px" data-options="showTip:true,rule: [0,'|',25,'|',50,'|',75,'|',100]">
				      </div>
				      <%-- 				   <div style="padding:3px;">
				        <label for="wareHouse.product.productId">仓库货品：</label>
				        <input id="wareHouse.product.productId" type="text" name="wareHouse.product.productName" value="${wareHouse.product.productName}" class="easyui-validatebox textbox" data-options="required:true"/>
				      </div> --%>				    
