...
<html>
  <head>
	...
	<link href="resources/css/common.css" rel="stylesheet"/>
 	<style>
        ...
        .pop_box .bg{background: #000;opacity: 0.7;filter:alpha(opacity=70);position: absolute;top:0;left: 0;right: 0;bottom: 0;height: 897px;}
        .pop_box .contentP{position: relative;margin:0 auto;margin-top: 1%; background: #fff;width: 80%;}
  ...
  <script>
                    ...
                    <div class="contentP">
                        ...
                        <div class="textmian">
                            ...
                            <table class="normTbe neijian" cellspacing="0" cellpadding="0" border="0" ;>
                             ...
                             <div class="btn_a2">
                                <a class="closepop" href="addNewwareHouseProduct">新增仓库货品</a>
                            </div>
                            <div class="btn_a1">
   ...
   <div id="main">
	<div id="toolbar">
		<a class="waves-effect waves-button" href="addPrewareHouse">
	...
	<table id="table"></table>
				  ...
				  <c:forEach items="${list2}" var="wareHouseProduct">
				  		<script>
				  			var productName="${wareHouseProduct.product.productName}";
				   	...
				   	<c:forEach items="${list}" var="wareHouse">
					    	 ...
					    	 var productName = "${wareHouse.product.productName}";
...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
			...
			/* {field: 'productName', title: '仓库货品', sortable: false, halign: 'center'}, */
...
function actionFormatter2(value, row, index){
	return [
      '<span data-href="testwareHouseProduct?wareId='+ row.wareHouse_id +'" class="innerbtn" style="color:blue;cursor:pointer">' + row.wareNo + '</span>'
      //
       ].join('');
}
/* function actionFormatter2(value, row, index){
