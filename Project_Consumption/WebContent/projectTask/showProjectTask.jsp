...
<html>
  ...
  <script>
   ...
   <form action="findbyNameproject" method="post" style="position:absolute;top:19px;right:187px;">
   ...
   <div id="main">
	<div id="toolbar">
		<a class="waves-effect waves-button" href="/Project_Consumption/project/addClient.jsp"><i class="zmdi zmdi-plus"></i> 新增客户</a>
	</div>
	<table id="table"></table>
				   	...
				   	<c:forEach items="${list}" var="project">
					    	 ...
					    	 var proNo = "PP"+"${project.proNo}";
					    	 var proName = "${project.proName}";
					    	 var manId = "${project.manId}";
					    	 var chargeMan = "${project.chargeMan}";
...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
			...
			{field: 'percent', title: '进度', sortable: false, halign: 'center'},
...
function actionFormatter(value, row, index) {
    return [
        '<a class="like" href="preupprojectTask?proId='+row.project_id+'" data-toggle="tooltip" style="color: red;border-bottom: 1px dotted;">具体进度</a>　',
        '<a class="edit ml10" href="prepupproject?projectId='+ row.project_id +'" data-toggle="tooltip" title="Edit"><i class="glyphicon glyphicon-edit"></i></a>　',
        '<a class="remove ml10" href="deleteproject?projectId='+ row.project_id +'" data-toggle="tooltip" title="Remove"><i class="glyphicon glyphicon-remove"></i></a>'
    ].join('');
}
