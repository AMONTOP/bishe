				  ...
				  <center>
				    ...
				    <form action="updateclient" method="post">
				      ...
				      <div style="padding:3px;">
				        ...
				        <input id="client.clientName" type="text" name="client.clientName" value="${client.clientName}" class="easyui-validatebox textbox" data-options="required:true,validType:'length[2,10]'"/>
				      </div>
				      <div style="padding:3px;">
				      ...
				      <div style="padding:3px;">
				        ...
				        <input id="client.contactPhone" type="text" name="client.contactPhone" value="${client.contactPhone}" class="easyui-validatebox textbox" data-options="required:true"/>
				      </div>
