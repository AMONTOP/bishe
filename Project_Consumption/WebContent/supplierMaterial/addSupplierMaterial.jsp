		...
		<div id="container" class="easyui-layout" style="width:1024px;height:800px;padding:1px;margin-left:auto; margin-right:auto;">
				<div id="mainbody" style="height:90%">
				  <center>
				    ...
				    <form action="savesupplierMaterial" method="post">
				      ...
				      <div style="padding:3px;">
				       ...
				       <div style="padding:3px;">
				        ...
				        <input id="supplierMaterial.price" type="text" name="supplierMaterial.price"  class="easyui-validatebox textbox" data-options="required:true"/>
				      </div>
				       <div style="padding:3px;">
				        <label for="supplierMaterial.remark">备注：</label>
				        <input id="supplierMaterial.remark" type="text" name="supplierMaterial.remark"  class="easyui-validatebox textbox" data-options="required:true"/>
				      </div>
