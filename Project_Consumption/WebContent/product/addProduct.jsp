...
<script>
	function randomNumber(){
		...
		/* console.log(hour); */
		return "P" + minutes.toString() + seconds.toString() + (Math.round(Math.random() * 4)).toString();
	};
	window.onload = function(){
    	document.getElementById("productNo").value = randomNumber();
	};
</script>
  </head>  
  <body>
				  ...
				  <center>
				    ...
				    <form action="saveproduct" method="post">
				      <div style="padding:3px;">
				        ...
				        <input id="productNo" type="text" name="product.productNo"  class="easyui-validatebox textbox" readonly/>
				      </div>
				      <div style="padding:3px;">
