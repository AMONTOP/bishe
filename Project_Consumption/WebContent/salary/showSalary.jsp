...
<html>
  ...
  <script>
   ...
   <div id="main">
	<div id="toolbar">
		<a class="waves-effect waves-button" href="addPresalary"><i class="zmdi zmdi-plus"></i> 新增员工工资信息</a>
	</div>
	<table id="table"></table>
				   	...
				   	<c:forEach items="${list}" var="salary">
						   	<script>
						   	 var id = "${salary.sid}";
						   	 var projectName = "${salary.projectTask.project.proName}";
					    	 var empId = "000"+"${salary.employee.empId}";
					    	 var empName = "${salary.employee.name}";
					    	 var taskId = "${salary.projectTask.taskId}";
					    	 var taskName = "${salary.projectTask.taskName}";
...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
			...
			{field: 'empId', title: '员工工号', sortable: false, halign: 'center'},
			{field: 'empName', title: '员工姓名', sortable: false, halign: 'center'},
			{field: 'projectName', title: '执行工程', sortable: false, halign: 'center'},
			{field: 'taskName', title: '执行任务', sortable: false, halign: 'center'},
			{field: 'startDate', title: '开始时间', sortable: false, halign: 'center'},
			{field: 'endDate', title: '结束时间', sortable: false, halign: 'center'},
			{field: 'day', title: '工作天数', sortable: false, halign: 'center'},
			{field: 'money', title: '一日工资', sortable: false, halign: 'center'},
			{field: 'totalMoney', title: '总工资', sortable: false, halign: 'center'},
			{field: 'state', title: '审核状态', sortable: false, halign: 'center'},
