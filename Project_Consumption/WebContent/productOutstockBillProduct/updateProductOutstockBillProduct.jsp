			...
			<div data-options="region:'center',title:'欢迎使用',iconCls:'icon-ok'" style="height:100%;">
				<div id="mainbody" style="height:90%">
				  <center>
				    ...
				    <form action="updateproductOutstockBillProduct" method="post">
				    <input id="billProductId" type="hidden" name="productOutstockBillProduct.billProductId" value="${productOutstockBillProduct.billProductId}"/>		
				      <div style="padding:3px;">
				        <label for="productOutstockBillProduct.productOutstockBill.billNo">领料单号：</label>
				        <select id="billId" name="productOutstockBillProduct.productOutstockBill.billId" class="easyui-validatebox textbox" style="width:180px;" onchange="aa()">
				       ...
				       <div style="padding:3px;">
				        ...
				        <label for="productOutstockBillProduct.product.productName">物料名称：</label>
				        
				        <select id="productId" name="productOutstockBillProduct.product.productId" class="easyui-validatebox textbox" style="width:180px;">
