				  ...
				  <center>
				    ...
				    <form action="savesupplier" method="post">
				      <div style="padding:3px;">
				        ...
				        <input id="supplierName" type="text" name="supplier.supplierName" value="${supplier.supplierName}" class="easyui-validatebox textbox" data-options="required:true,validType:'length[2,20]'"/>
				      </div>
				      <div style="padding:3px;">
