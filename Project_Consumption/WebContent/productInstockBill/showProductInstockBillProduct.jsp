 ...
 <form action="findbyNameproduct" method="post" style="position:absolute;top:19px;right:187px;">
	   <p class="columns pull-right search-button">
	    ...
	    <p class="columns pull-right search-input">
	   		<input class="form-control" name="product.productName"  type="text" placeholder="请根据入库单编号搜索">
	   </p>
   </form>

<div id="main">
    <div id="toolbar">
        <a class="waves-effect waves-button" href="addPre2productInstockBill"><i class="zmdi zmdi-plus"></i> 新增货品入库单货品</a>
    </div>
    ...
    $(function() {
        ...
        $table.bootstrapTable({
            ...
            columns: [
                ...
                {field: 'productName', title: '入库货品', sortable: false, halign: 'center'},
