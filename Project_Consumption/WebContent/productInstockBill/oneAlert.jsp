...
<script>
 ...
 <div class="pop_box hide">
                    ...
                    <div class="contentP">
                        ...
                        <div class="textmian">
                        	<p>审核中需要进行货品品质检测</p>
                        	<c:forEach items="${list}" var="productInstockBill" varStatus="status">
	                        	<form action="test2productInstockBill" method="post" id="myform${status.index}" style="text-align: center;">				    				   							    
								      <input type="hidden" name="productInstockBill.product.productId" value="${productInstockBill.product.productId}" />	
								      <input type="text" value="${productInstockBill.product.productName}" />		        
								      <input type="hidden" name="productInstockBill.employee.empId" value="${empId}" />							  			      							        
								      <input type="hidden" name="productInstockBill.billState" value="0"/>
								      <input type="hidden" name="productInstockBill.billId" value="${productInstockBill.billId}"/>							      				    
