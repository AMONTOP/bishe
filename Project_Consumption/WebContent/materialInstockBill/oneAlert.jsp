...
<script>
 ...
 <div class="pop_box hide">
                    ...
                    <div class="contentP">
                        ...
                        <div class="textmian">
                        	<p style="font-size: 17px;">注意：审核中需要进行货品品质检测,点击检测进入品质检测页面！</p>
                       		<form action="test2materialInstockBill" method="post">				    				   							    
							      <input type="hidden" name="materialInstockBill.material.materialId" value="${materialInstockBill.material.materialId}" />			        
							      <input type="hidden" name="materialInstockBill.employee.empId" value="${materialInstockBill.employee.empId }" />							  			      							        
							      <input type="hidden" name="materialInstockBill.billState" value="${materialInstockBill.billState}"/>
							      <input type="hidden" name="materialInstockBill.billId" value="${materialInstockBill.billId}"/>							      				    
							      <div style="padding:3px;text-align:center">				     
							        <input type="submit" value="检测" style="width: 120px;height: 45px;background: #50abfd;border: none;color: white;font-size: 15px;"/>
							      </div>
				    		</form>
                           <!--  <div class="btn_a1">
