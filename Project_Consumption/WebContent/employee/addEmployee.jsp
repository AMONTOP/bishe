  ...
  <body>
		<div id="container" class="easyui-layout" style="width:1024px;height:800px;padding:1px;margin-left:auto; margin-right:auto;">
				...
				<div id="mainbody" style="height:90%">
				  <center>
				    <h1 style="color:skyblue;">添加员工记录</h1>
				    ...
				    <form action="employee-save" method="post">				      
				      <div style="padding:3px;">
				        ...
				        <input id="employee.userName" type="text" name="employee.userName" value="${employee.userName}" class="easyui-validatebox textbox" data-options="required:true,validType:'length[2,10]'"/>
				      </div>
				      <div style="padding:3px;">
