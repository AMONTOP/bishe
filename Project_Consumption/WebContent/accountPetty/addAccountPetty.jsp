...
<script>
	...
	window.onload = function(){
    	document.getElementById("pettyNo").value = randomNumber();
	};
</script>
  </head>  
  <body>
		<div id="container" class="easyui-layout" style="width:1024px;height:800px;padding:1px;margin-left:auto; margin-right:auto;">
				<div id="mainbody" style="height:90%">
				  <center>
				    ...
				    <form action="saveaccountPetty" method="post">
				      ...
				      <input type="hidden" id="accountPettyId" name="accountPetty.accountPettyId" value="${sessionScope.session_accountPetty.accountPetty_id}"/>
