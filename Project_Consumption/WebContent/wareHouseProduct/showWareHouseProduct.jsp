...
<html>
  ...
  <script>
   ...
   <div id="main">
	<div id="toolbar">
		<a class="waves-effect waves-button" href="addPrewareHouseProduct">
...
function actionFormatter2(value, row, index){
	return [
      '<a href="showBybillNoproductInstockBill?wareId= '+ row.wareHouse_id +'" class="innerbtn" style="color:blue" >' + row.wareNo + '</a>'
       ].join('');
}
/* function actionFormatter2(value, row, index){
	return [
