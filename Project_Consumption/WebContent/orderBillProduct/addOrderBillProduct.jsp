  ...
  <body>
		<div id="container" class="easyui-layout" style="width:1024px;height:800px;padding:1px;margin-left:auto; margin-right:auto;">
			<div id="mainbody" style="height:90%">
				  <center>
				    <h1 style="color:skyblue;">添加订单货品</h1>
				    <div style="padding:3px;color:red;">
				      ${msg}
				    </div>
				    <form action="saveorderBillProduct" method="post">
				      <div style="padding:3px;">
				        <label for="billNo">订单编号：</label>
				        <select id="billId" name="orderBillProduct.orderBill.billId" class="easyui-validatebox textbox" style="width:280px;">
