   ...
   <form action="findbyNamematerial" method="post" style="position:absolute;top:19px;right:187px;">
	   <p class="columns pull-right search-button">
	    ...
	    <p class="columns pull-right search-input">
	   		<input class="form-control" name="material.materialName"  type="text" placeholder="根据物料名称搜索">
	   </p>
   </form>
				 
	<div id="main">
		<div id="toolbar">
			<a class="waves-effect waves-button" href="addPrematerial"><i class="zmdi zmdi-plus"></i> 新增物料</a>
		</div>
		<table id="table"></table>
				   	...
				   	<c:forEach items="${list}" var="material">
				        <script>
					    	 ...
					    	 var materialCategory = "${material.materialCategory.categoryName}";
					    	 var unit = "${material.unit}";
					    	 var spec = "${material.spec}";
					    	 var cost = ${material.cost};
					    	 var remark = "${material.remark}";
...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
			...
			{field: 'material_category', title: '物料类别', sortable: false, halign: 'center'},
...
function actionFormatter(value, row, index) {
    return [
        ...
        '<a class="edit ml10" href="prepupmaterial?materialId='+ row.material_id +'" data-toggle="tooltip" title="Edit"><i class="glyphicon glyphicon-edit"></i></a>　',
        '<a class="remove ml10" href="deletematerial?materialId='+ row.material_id +'" data-toggle="tooltip" title="Remove"><i class="glyphicon glyphicon-remove"></i></a>'
    ].join('');
}
