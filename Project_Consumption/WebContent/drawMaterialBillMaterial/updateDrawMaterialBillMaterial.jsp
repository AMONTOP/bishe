		...
		<div id="container" class="easyui-layout" style="width:1024px;height:800px;padding:1px;margin-left:auto; margin-right:auto;">
			<div id="mainbody" style="height:90%">
				  <center>
				    ...
				    <form action="updatedrawMaterialBillMaterial" method="post">
				    <input id="billMaterialId" type="hidden" name="drawMaterialBillMaterial.billMaterialId" value="${drawMaterialBillMaterial.billMaterialId}"/>		
